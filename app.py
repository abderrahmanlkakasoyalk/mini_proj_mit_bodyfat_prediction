...
def main():
    ...
    chest = st.number_input('Chest circumference (cm)', value=85.0, step=0.1)
    abdomen = st.number_input('Abdomen circumference (cm)', value=80.0, step=0.1)
    hip = st.number_input('Hip circumference (cm)', value=80.0, step=0.1)
    thigh = st.number_input('Thigh circumference (cm)', value=50.0, step=0.1)
    knee = st.number_input('Knee circumference (cm)', value=30.0, step=0.1)
    biceps = st.number_input('Biceps circumference (cm)', value=25.0, step=0.1)
